...
long_ui <-
  fluidPage(
    titlePanel("MicrobiomeStat Long Report"),
    ...
    fluidRow(
      column(6,
             ...
             selectInput('t0Level', 'T0 Level', choices = NULL),
             selectInput('tsLevels', 'TS Levels', choices = NULL, multiple = TRUE),
             selectInput('alphaName', 'Alpha Diversity Index',
                         ...
                         multiple = TRUE),
             selectInput('alphaChangeFunc', 'Alpha Change Function', choices = c('log fold change', 'absolute change')),
             selectInput('depth', 'Depth', choices = NULL)
      ),
      column(6,
             ...
             selectInput('featureChangeFunc', 'Feature Change Function', choices = c('relative change', 'absolute change', 'log fold change')),
